...
import de.tekup.endPoint.WhiteTestEndPoint;
...
public class WhiteTestConfig {
	...
	public ServletRegistrationBean<MessageDispatcherServlet> messagedipatcherServlet (ApplicationContext context) {
	  ...
	  return new ServletRegistrationBean<MessageDispatcherServlet>(servlet,"/whitetest/*");
	...
	public DefaultWsdl11Definition defaultWsdl11Definition(XsdSchema schema) {
		...
		defaultWsdl11Definition.setLocationUri("http://localhost:8080/whitetest");
