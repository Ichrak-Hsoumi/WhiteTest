...
// Généré le : 2021.05.16 à 04:29:29 AM CEST 
//
...
public class ObjectFactory {
    ...
    private final static QName _StudentOrder_QNAME = new QName("http://www.tekup.de/soap/models/whitetest", "StudentOrder");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.tekup.de/soap/models/whitetest", name = "StudentOrder")
    public JAXBElement<Student> createStudentOrder(Student value) {
        return new JAXBElement<Student>(_StudentOrder_QNAME, Student.class, null, value);
    }
